 ...
 * Categorías no registradas: prioridad >= 11 y emoji 🔹.
 */

const DEFAULT_CATEGORY_PRIORITY = 11;
...
const CATEGORY_PRIORITY_CONFIG = Object.freeze({
    ...
    Iglesia: { priority: 4, emoji: '🟫' },
    F_i: { priority: 5, emoji: '🔴' },
    Aseo: { priority: 6, emoji: '🩶' },
    Carrera: { priority: 7, emoji: '🟡' },
    Universidad: { priority: 8, emoji: '🟡' },
    Traffix: { priority: 9, emoji: '🟫' },
    S_j: { priority: 10, emoji: '🟢' },
});
